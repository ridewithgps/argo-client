...
# Unit tests for argo-workflows::IoArgoprojWorkflowV1alpha1LogEntry
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'IoArgoprojWorkflowV1alpha1LogEntry' do
  before do
    # run before each test
    @instance = argo-workflows::IoArgoprojWorkflowV1alpha1LogEntry.new
  end
  ...
  describe 'test an instance of IoArgoprojWorkflowV1alpha1LogEntry' do
    it 'should create an instance of IoArgoprojWorkflowV1alpha1LogEntry' do
      expect(@instance).to be_instance_of(argo-workflows::IoArgoprojWorkflowV1alpha1LogEntry)
    end
  end
