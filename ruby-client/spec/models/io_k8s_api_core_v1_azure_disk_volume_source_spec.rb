...
# Unit tests for ArgoWorkflows::IoK8sApiCoreV1AzureDiskVolumeSource
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'IoK8sApiCoreV1AzureDiskVolumeSource' do
  before do
    # run before each test
    @instance = ArgoWorkflows::IoK8sApiCoreV1AzureDiskVolumeSource.new
  end
  ...
  describe 'test an instance of IoK8sApiCoreV1AzureDiskVolumeSource' do
    it 'should create an instance of IoK8sApiCoreV1AzureDiskVolumeSource' do
      expect(@instance).to be_instance_of(ArgoWorkflows::IoK8sApiCoreV1AzureDiskVolumeSource)
    end
  end
