...
# Unit tests for argo-workflows::IoK8sApiPolicyV1PodDisruptionBudgetSpec
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'IoK8sApiPolicyV1PodDisruptionBudgetSpec' do
  before do
    # run before each test
    @instance = argo-workflows::IoK8sApiPolicyV1PodDisruptionBudgetSpec.new
  end
  ...
  describe 'test an instance of IoK8sApiPolicyV1PodDisruptionBudgetSpec' do
    it 'should create an instance of IoK8sApiPolicyV1PodDisruptionBudgetSpec' do
      expect(@instance).to be_instance_of(argo-workflows::IoK8sApiPolicyV1PodDisruptionBudgetSpec)
    end
  end
