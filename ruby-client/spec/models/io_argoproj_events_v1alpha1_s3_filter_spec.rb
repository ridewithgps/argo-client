...
# Unit tests for argo-workflows::IoArgoprojEventsV1alpha1S3Filter
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'IoArgoprojEventsV1alpha1S3Filter' do
  before do
    # run before each test
    @instance = argo-workflows::IoArgoprojEventsV1alpha1S3Filter.new
  end
  ...
  describe 'test an instance of IoArgoprojEventsV1alpha1S3Filter' do
    it 'should create an instance of IoArgoprojEventsV1alpha1S3Filter' do
      expect(@instance).to be_instance_of(argo-workflows::IoArgoprojEventsV1alpha1S3Filter)
    end
  end
