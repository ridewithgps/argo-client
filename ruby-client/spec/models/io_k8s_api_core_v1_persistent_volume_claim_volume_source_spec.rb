...
# Unit tests for argo-workflows::IoK8sApiCoreV1PersistentVolumeClaimVolumeSource
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'IoK8sApiCoreV1PersistentVolumeClaimVolumeSource' do
  before do
    # run before each test
    @instance = argo-workflows::IoK8sApiCoreV1PersistentVolumeClaimVolumeSource.new
  end
  ...
  describe 'test an instance of IoK8sApiCoreV1PersistentVolumeClaimVolumeSource' do
    it 'should create an instance of IoK8sApiCoreV1PersistentVolumeClaimVolumeSource' do
      expect(@instance).to be_instance_of(argo-workflows::IoK8sApiCoreV1PersistentVolumeClaimVolumeSource)
    end
  end
