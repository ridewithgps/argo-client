...
# Unit tests for ArgoWorkflows::IoK8sApimachineryPkgApisMetaV1LabelSelector
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'IoK8sApimachineryPkgApisMetaV1LabelSelector' do
  before do
    # run before each test
    @instance = ArgoWorkflows::IoK8sApimachineryPkgApisMetaV1LabelSelector.new
  end
  ...
  describe 'test an instance of IoK8sApimachineryPkgApisMetaV1LabelSelector' do
    it 'should create an instance of IoK8sApimachineryPkgApisMetaV1LabelSelector' do
      expect(@instance).to be_instance_of(ArgoWorkflows::IoK8sApimachineryPkgApisMetaV1LabelSelector)
    end
  end
