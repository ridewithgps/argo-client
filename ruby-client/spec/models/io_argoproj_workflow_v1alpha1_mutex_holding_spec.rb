...
# Unit tests for argo-workflows::IoArgoprojWorkflowV1alpha1MutexHolding
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'IoArgoprojWorkflowV1alpha1MutexHolding' do
  before do
    # run before each test
    @instance = argo-workflows::IoArgoprojWorkflowV1alpha1MutexHolding.new
  end
  ...
  describe 'test an instance of IoArgoprojWorkflowV1alpha1MutexHolding' do
    it 'should create an instance of IoArgoprojWorkflowV1alpha1MutexHolding' do
      expect(@instance).to be_instance_of(argo-workflows::IoArgoprojWorkflowV1alpha1MutexHolding)
    end
  end
