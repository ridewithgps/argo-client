...
# Unit tests for argo-workflows::IoArgoprojEventsV1alpha1StripeEventSource
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'IoArgoprojEventsV1alpha1StripeEventSource' do
  before do
    # run before each test
    @instance = argo-workflows::IoArgoprojEventsV1alpha1StripeEventSource.new
  end
  ...
  describe 'test an instance of IoArgoprojEventsV1alpha1StripeEventSource' do
    it 'should create an instance of IoArgoprojEventsV1alpha1StripeEventSource' do
      expect(@instance).to be_instance_of(argo-workflows::IoArgoprojEventsV1alpha1StripeEventSource)
    end
  end
