...
# Unit tests for ArgoWorkflows::IoArgoprojEventsV1alpha1EventDependencyTransformer
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'IoArgoprojEventsV1alpha1EventDependencyTransformer' do
  before do
    # run before each test
    @instance = ArgoWorkflows::IoArgoprojEventsV1alpha1EventDependencyTransformer.new
  end
  ...
  describe 'test an instance of IoArgoprojEventsV1alpha1EventDependencyTransformer' do
    it 'should create an instance of IoArgoprojEventsV1alpha1EventDependencyTransformer' do
      expect(@instance).to be_instance_of(ArgoWorkflows::IoArgoprojEventsV1alpha1EventDependencyTransformer)
    end
  end
