...
# Unit tests for argo-workflows::IoArgoprojWorkflowV1alpha1ExecutorConfig
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'IoArgoprojWorkflowV1alpha1ExecutorConfig' do
  before do
    # run before each test
    @instance = argo-workflows::IoArgoprojWorkflowV1alpha1ExecutorConfig.new
  end
  ...
  describe 'test an instance of IoArgoprojWorkflowV1alpha1ExecutorConfig' do
    it 'should create an instance of IoArgoprojWorkflowV1alpha1ExecutorConfig' do
      expect(@instance).to be_instance_of(argo-workflows::IoArgoprojWorkflowV1alpha1ExecutorConfig)
    end
  end
