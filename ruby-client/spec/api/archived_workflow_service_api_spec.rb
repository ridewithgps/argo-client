...
# Unit tests for argo-workflows::ArchivedWorkflowServiceApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ArchivedWorkflowServiceApi' do
  before do
    # run before each test
    @instance = argo-workflows::ArchivedWorkflowServiceApi.new
  end
  ...
  describe 'test an instance of ArchivedWorkflowServiceApi' do
    it 'should create an instance of ArchivedWorkflowServiceApi' do
      expect(@instance).to be_instance_of(argo-workflows::ArchivedWorkflowServiceApi)
    end
  end

  # unit tests for archived_workflow_service_delete_archived_workflow
  # @param uid 
  # @param [Hash] opts the optional parameters
  # @option opts [String] :namespace 
  # @return [IoArgoprojWorkflowV1alpha1ArchivedWorkflowDeletedResponse]
  describe 'archived_workflow_service_delete_archived_workflow test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for archived_workflow_service_get_archived_workflow
  # @param uid 
  # @param [Hash] opts the optional parameters
  # @option opts [String] :namespace 
  # @option opts [String] :name 
  # @return [IoArgoprojWorkflowV1alpha1Workflow]
  describe 'archived_workflow_service_get_archived_workflow test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for archived_workflow_service_list_archived_workflow_label_keys
  # @param [Hash] opts the optional parameters
  # @option opts [String] :namespace 
  # @return [IoArgoprojWorkflowV1alpha1LabelKeys]
  describe 'archived_workflow_service_list_archived_workflow_label_keys test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for archived_workflow_service_list_archived_workflow_label_values
  # @param [Hash] opts the optional parameters
  ...
  describe 'archived_workflow_service_list_archived_workflow_label_values test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for archived_workflow_service_list_archived_workflows
  # @param [Hash] opts the optional parameters
  # @option opts [String] :list_options_label_selector A selector to restrict the list of returned objects by their labels. Defaults to everything. +optional.
  # @option opts [String] :list_options_field_selector A selector to restrict the list of returned objects by their fields. Defaults to everything. +optional.
  # @option opts [BOOLEAN] :list_options_watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion. +optional.
  ...
  describe 'archived_workflow_service_list_archived_workflows test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for archived_workflow_service_resubmit_archived_workflow
  # @param uid 
  # @param body 
  # @param [Hash] opts the optional parameters
  # @return [IoArgoprojWorkflowV1alpha1Workflow]
  describe 'archived_workflow_service_resubmit_archived_workflow test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for archived_workflow_service_retry_archived_workflow
  # @param uid 
  # @param body 
  # @param [Hash] opts the optional parameters
  # @return [IoArgoprojWorkflowV1alpha1Workflow]
  describe 'archived_workflow_service_retry_archived_workflow test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
