...
# Unit tests for ArgoWorkflows::WorkflowServiceApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'WorkflowServiceApi' do
  before do
    # run before each test
    @instance = ArgoWorkflows::WorkflowServiceApi.new
  end
  ...
  describe 'test an instance of WorkflowServiceApi' do
    it 'should create an instance of WorkflowServiceApi' do
      expect(@instance).to be_instance_of(ArgoWorkflows::WorkflowServiceApi)
    end
  end
