...
# Unit tests for argo-workflows::EventServiceApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'EventServiceApi' do
  before do
    # run before each test
    @instance = argo-workflows::EventServiceApi.new
  end
  ...
  describe 'test an instance of EventServiceApi' do
    it 'should create an instance of EventServiceApi' do
      expect(@instance).to be_instance_of(argo-workflows::EventServiceApi)
    end
  end
