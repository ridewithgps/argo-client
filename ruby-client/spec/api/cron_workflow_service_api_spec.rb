...
# Unit tests for argo-workflows::CronWorkflowServiceApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CronWorkflowServiceApi' do
  before do
    # run before each test
    @instance = argo-workflows::CronWorkflowServiceApi.new
  end
  ...
  describe 'test an instance of CronWorkflowServiceApi' do
    it 'should create an instance of CronWorkflowServiceApi' do
      expect(@instance).to be_instance_of(argo-workflows::CronWorkflowServiceApi)
    end
  end
