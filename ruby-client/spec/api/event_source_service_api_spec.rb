...
# Unit tests for ArgoWorkflows::EventSourceServiceApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'EventSourceServiceApi' do
  before do
    # run before each test
    @instance = ArgoWorkflows::EventSourceServiceApi.new
  end
  ...
  describe 'test an instance of EventSourceServiceApi' do
    it 'should create an instance of EventSourceServiceApi' do
      expect(@instance).to be_instance_of(ArgoWorkflows::EventSourceServiceApi)
    end
  end
