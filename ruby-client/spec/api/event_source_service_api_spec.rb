...
# Unit tests for argo-workflows::EventSourceServiceApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'EventSourceServiceApi' do
  before do
    # run before each test
    @instance = argo-workflows::EventSourceServiceApi.new
  end
  ...
  describe 'test an instance of EventSourceServiceApi' do
    it 'should create an instance of EventSourceServiceApi' do
      expect(@instance).to be_instance_of(argo-workflows::EventSourceServiceApi)
    end
  end

  # unit tests for event_source_service_create_event_source
  # @param namespace 
  # @param body 
  # @param [Hash] opts the optional parameters
  # @return [IoArgoprojEventsV1alpha1EventSource]
  describe 'event_source_service_create_event_source test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for event_source_service_delete_event_source
  # @param namespace 
  # @param name 
  # @param [Hash] opts the optional parameters
  ...
  describe 'event_source_service_delete_event_source test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for event_source_service_event_sources_logs
  # @param namespace 
  # @param [Hash] opts the optional parameters
  ...
  describe 'event_source_service_event_sources_logs test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for event_source_service_get_event_source
  # @param namespace 
  # @param name 
  # @param [Hash] opts the optional parameters
  # @return [IoArgoprojEventsV1alpha1EventSource]
  describe 'event_source_service_get_event_source test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for event_source_service_list_event_sources
  # @param namespace 
  # @param [Hash] opts the optional parameters
  ...
  describe 'event_source_service_list_event_sources test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for event_source_service_update_event_source
  # @param namespace 
  # @param name 
  # @param body 
  # @param [Hash] opts the optional parameters
  # @return [IoArgoprojEventsV1alpha1EventSource]
  describe 'event_source_service_update_event_source test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for event_source_service_watch_event_sources
  # @param namespace 
  # @param [Hash] opts the optional parameters
  # @option opts [String] :list_options_label_selector A selector to restrict the list of returned objects by their labels. Defaults to everything. +optional.
  # @option opts [String] :list_options_field_selector A selector to restrict the list of returned objects by their fields. Defaults to everything. +optional.
  ...
  describe 'event_source_service_watch_event_sources test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
