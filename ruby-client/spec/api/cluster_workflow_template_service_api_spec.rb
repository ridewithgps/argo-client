...
# Unit tests for argo-workflows::ClusterWorkflowTemplateServiceApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ClusterWorkflowTemplateServiceApi' do
  before do
    # run before each test
    @instance = argo-workflows::ClusterWorkflowTemplateServiceApi.new
  end
  ...
  describe 'test an instance of ClusterWorkflowTemplateServiceApi' do
    it 'should create an instance of ClusterWorkflowTemplateServiceApi' do
      expect(@instance).to be_instance_of(argo-workflows::ClusterWorkflowTemplateServiceApi)
    end
  end

  # unit tests for cluster_workflow_template_service_create_cluster_workflow_template
  # @param body 
  # @param [Hash] opts the optional parameters
  # @return [IoArgoprojWorkflowV1alpha1ClusterWorkflowTemplate]
  describe 'cluster_workflow_template_service_create_cluster_workflow_template test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for cluster_workflow_template_service_delete_cluster_workflow_template
  # @param name 
  # @param [Hash] opts the optional parameters
  ...
  describe 'cluster_workflow_template_service_delete_cluster_workflow_template test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for cluster_workflow_template_service_get_cluster_workflow_template
  # @param name 
  # @param [Hash] opts the optional parameters
  ...
  # @return [IoArgoprojWorkflowV1alpha1ClusterWorkflowTemplate]
  describe 'cluster_workflow_template_service_get_cluster_workflow_template test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for cluster_workflow_template_service_lint_cluster_workflow_template
  # @param body 
  # @param [Hash] opts the optional parameters
  # @return [IoArgoprojWorkflowV1alpha1ClusterWorkflowTemplate]
  describe 'cluster_workflow_template_service_lint_cluster_workflow_template test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for cluster_workflow_template_service_list_cluster_workflow_templates
  # @param [Hash] opts the optional parameters
  ...
  describe 'cluster_workflow_template_service_list_cluster_workflow_templates test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for cluster_workflow_template_service_update_cluster_workflow_template
  # @param name DEPRECATED: This field is ignored.
  # @param body 
  # @param [Hash] opts the optional parameters
  # @return [IoArgoprojWorkflowV1alpha1ClusterWorkflowTemplate]
  describe 'cluster_workflow_template_service_update_cluster_workflow_template test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
