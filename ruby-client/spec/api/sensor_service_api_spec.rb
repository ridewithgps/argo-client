...
# Unit tests for ArgoWorkflows::SensorServiceApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SensorServiceApi' do
  before do
    # run before each test
    @instance = ArgoWorkflows::SensorServiceApi.new
  end
  ...
  describe 'test an instance of SensorServiceApi' do
    it 'should create an instance of SensorServiceApi' do
      expect(@instance).to be_instance_of(ArgoWorkflows::SensorServiceApi)
    end
  end
