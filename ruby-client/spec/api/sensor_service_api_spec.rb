...
# Unit tests for argo-workflows::SensorServiceApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SensorServiceApi' do
  before do
    # run before each test
    @instance = argo-workflows::SensorServiceApi.new
  end
  ...
  describe 'test an instance of SensorServiceApi' do
    it 'should create an instance of SensorServiceApi' do
      expect(@instance).to be_instance_of(argo-workflows::SensorServiceApi)
    end
  end

  # unit tests for sensor_service_create_sensor
  # @param namespace 
  # @param body 
  # @param [Hash] opts the optional parameters
  # @return [IoArgoprojEventsV1alpha1Sensor]
  describe 'sensor_service_create_sensor test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for sensor_service_delete_sensor
  # @param namespace 
  # @param name 
  # @param [Hash] opts the optional parameters
  ...
  describe 'sensor_service_delete_sensor test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for sensor_service_get_sensor
  # @param namespace 
  # @param name 
  # @param [Hash] opts the optional parameters
  ...
  # @return [IoArgoprojEventsV1alpha1Sensor]
  describe 'sensor_service_get_sensor test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for sensor_service_list_sensors
  # @param namespace 
  # @param [Hash] opts the optional parameters
  ...
  describe 'sensor_service_list_sensors test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for sensor_service_sensors_logs
  # @param namespace 
  # @param [Hash] opts the optional parameters
  ...
  describe 'sensor_service_sensors_logs test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for sensor_service_update_sensor
  # @param namespace 
  # @param name 
  # @param body 
  # @param [Hash] opts the optional parameters
  # @return [IoArgoprojEventsV1alpha1Sensor]
  describe 'sensor_service_update_sensor test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for sensor_service_watch_sensors
  # @param namespace 
  # @param [Hash] opts the optional parameters
  # @option opts [String] :list_options_label_selector A selector to restrict the list of returned objects by their labels. Defaults to everything. +optional.
  # @option opts [String] :list_options_field_selector A selector to restrict the list of returned objects by their fields. Defaults to everything. +optional.
  ...
  describe 'sensor_service_watch_sensors test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
