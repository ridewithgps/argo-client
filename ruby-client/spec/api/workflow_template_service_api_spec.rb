...
# Unit tests for argo-workflows::WorkflowTemplateServiceApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'WorkflowTemplateServiceApi' do
  before do
    # run before each test
    @instance = argo-workflows::WorkflowTemplateServiceApi.new
  end
  ...
  describe 'test an instance of WorkflowTemplateServiceApi' do
    it 'should create an instance of WorkflowTemplateServiceApi' do
      expect(@instance).to be_instance_of(argo-workflows::WorkflowTemplateServiceApi)
    end
  end

  # unit tests for workflow_template_service_create_workflow_template
  # @param namespace 
  # @param body 
  # @param [Hash] opts the optional parameters
  # @return [IoArgoprojWorkflowV1alpha1WorkflowTemplate]
  describe 'workflow_template_service_create_workflow_template test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for workflow_template_service_delete_workflow_template
  # @param namespace 
  # @param name 
  # @param [Hash] opts the optional parameters
  ...
  describe 'workflow_template_service_delete_workflow_template test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for workflow_template_service_get_workflow_template
  # @param namespace 
  # @param name 
  # @param [Hash] opts the optional parameters
  ...
  # @return [IoArgoprojWorkflowV1alpha1WorkflowTemplate]
  describe 'workflow_template_service_get_workflow_template test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for workflow_template_service_lint_workflow_template
  # @param namespace 
  # @param body 
  # @param [Hash] opts the optional parameters
  # @return [IoArgoprojWorkflowV1alpha1WorkflowTemplate]
  describe 'workflow_template_service_lint_workflow_template test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for workflow_template_service_list_workflow_templates
  # @param namespace 
  # @param [Hash] opts the optional parameters
  ...
  describe 'workflow_template_service_list_workflow_templates test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for workflow_template_service_update_workflow_template
  # @param namespace 
  # @param name DEPRECATED: This field is ignored.
  # @param body 
  # @param [Hash] opts the optional parameters
  # @return [IoArgoprojWorkflowV1alpha1WorkflowTemplate]
  describe 'workflow_template_service_update_workflow_template test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
