...
module argo-workflows
  class IoArgoprojWorkflowV1alpha1HTTP
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'bodyFrom')
        self.body_from = attributes[:'bodyFrom']
      end
    ...
    def hash
      [body, body_from, headers, insecure_skip_verify, method, success_condition, timeout_seconds, url].hash
    end
