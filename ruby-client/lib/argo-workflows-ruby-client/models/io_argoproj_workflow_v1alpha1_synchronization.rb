...
module argo-workflows
  ...
  class IoArgoprojWorkflowV1alpha1Synchronization
    ...
    def self.swagger_types
      {
        ...
        :'mutexes' => :'Array<IoArgoprojWorkflowV1alpha1Mutex>',
        :'semaphore' => :'IoArgoprojWorkflowV1alpha1SemaphoreRef',
        :'semaphores' => :'Array<IoArgoprojWorkflowV1alpha1SemaphoreRef>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'mutex')
        self.mutex = attributes[:'mutex']
      end

      if attributes.has_key?(:'mutexes')
        if (value = attributes[:'mutexes']).is_a?(Array)
          self.mutexes = value
        end
      end

      if attributes.has_key?(:'semaphore')
        self.semaphore = attributes[:'semaphore']
      end

      if attributes.has_key?(:'semaphores')
        if (value = attributes[:'semaphores']).is_a?(Array)
    ...
    def hash
      [mutex, mutexes, semaphore, semaphores].hash
    end
