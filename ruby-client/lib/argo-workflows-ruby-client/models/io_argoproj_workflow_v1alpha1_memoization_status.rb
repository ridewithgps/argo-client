...
module argo-workflows
  ...
  class IoArgoprojWorkflowV1alpha1MemoizationStatus
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'cacheName')
        self.cache_name = attributes[:'cacheName']
      end

      if attributes.has_key?(:'hit')
    ...
    def list_invalid_properties
      ...
      if @cache_name.nil?
        invalid_properties.push('invalid value for "cache_name", cache_name cannot be nil.')
      end
    ...
    def valid?
      return false if @cache_name.nil?
