...
module argo-workflows
  class IoArgoprojWorkflowV1alpha1ArtifactRepositoryRefStatus
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'artifactRepository')
        self.artifact_repository = attributes[:'artifactRepository']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          artifact_repository == o.artifact_repository &&
    ...
    def hash
      [artifact_repository, config_map, default, key, namespace].hash
    end
