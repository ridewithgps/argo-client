...
module argo-workflows
  ...
  class IoArgoprojWorkflowV1alpha1Gauge
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'realtime')
    ...
    def list_invalid_properties
      ...
      if @realtime.nil?
        invalid_properties.push('invalid value for "realtime", realtime cannot be nil.')
      end
