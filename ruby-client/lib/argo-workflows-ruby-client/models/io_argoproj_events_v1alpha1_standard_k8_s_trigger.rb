...
module argo-workflows
  class IoArgoprojEventsV1alpha1StandardK8STrigger
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'liveObject')
        self.live_object = attributes[:'liveObject']
      end
      ...
      if attributes.has_key?(:'patchStrategy')
        self.patch_strategy = attributes[:'patchStrategy']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          live_object == o.live_object &&
          operation == o.operation &&
          parameters == o.parameters &&
          patch_strategy == o.patch_strategy &&
          source == o.source
    end
    ...
    def hash
      [live_object, operation, parameters, patch_strategy, source].hash
    end
