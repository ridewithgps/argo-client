...
module argo-workflows
  class IoArgoprojEventsV1alpha1GerritEventSource
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'gerritBaseURL')
        self.gerrit_base_url = attributes[:'gerritBaseURL']
      end

      if attributes.has_key?(:'hookName')
        self.hook_name = attributes[:'hookName']
      end
      ...
      if attributes.has_key?(:'sslVerify')
        self.ssl_verify = attributes[:'sslVerify']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          events == o.events &&
          filter == o.filter &&
          gerrit_base_url == o.gerrit_base_url &&
          hook_name == o.hook_name &&
          metadata == o.metadata &&
          projects == o.projects &&
    ...
    def hash
      [auth, delete_hook_on_finish, events, filter, gerrit_base_url, hook_name, metadata, projects, ssl_verify, webhook].hash
    end
