...
module argo-workflows
  class IoArgoprojEventsV1alpha1GitArtifact
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'cloneDirectory')
        self.clone_directory = attributes[:'cloneDirectory']
      end

      if attributes.has_key?(:'creds')
    ...
    def ==(o)
      ...
      self.class == o.class &&
          branch == o.branch &&
          clone_directory == o.clone_directory &&
          creds == o.creds &&
    ...
    def hash
      [branch, clone_directory, creds, file_path, insecure_ignore_host_key, ref, remote, ssh_key_secret, tag, url].hash
    end
