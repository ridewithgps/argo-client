...
module argo-workflows
  ...
  class IoK8sApiCoreV1VolumeProjection
    ...
    def self.swagger_types
      {
        :'cluster_trust_bundle' => :'IoK8sApiCoreV1ClusterTrustBundleProjection',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'clusterTrustBundle')
        self.cluster_trust_bundle = attributes[:'clusterTrustBundle']
      end
      ...
      if attributes.has_key?(:'serviceAccountToken')
        self.service_account_token = attributes[:'serviceAccountToken']
      end
    end
    ...
    def hash
      [cluster_trust_bundle, config_map, downward_api, secret, service_account_token].hash
    end
