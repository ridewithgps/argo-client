...
module argo-workflows
  ...
  class IoArgoprojEventsV1alpha1CustomTrigger
    ...
    attr_accessor :server_name_override
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'certSecret')
        self.cert_secret = attributes[:'certSecret']
      end
      ...
      if attributes.has_key?(:'serverNameOverride')
        self.server_name_override = attributes[:'serverNameOverride']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          cert_secret == o.cert_secret &&
          parameters == o.parameters &&
          payload == o.payload &&
          secure == o.secure &&
          server_name_override == o.server_name_override &&
    ...
    def hash
      [cert_secret, parameters, payload, secure, server_name_override, server_url, spec].hash
    end
