...
module argo-workflows
  class IoArgoprojEventsV1alpha1RedisStreamEventSource
    ...
    attr_accessor :max_msg_count_per_read
    ...
    def self.swagger_types
      {
        ...
        :'host_address' => :'String',
        :'max_msg_count_per_read' => :'Integer',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'maxMsgCountPerRead')
        self.max_msg_count_per_read = attributes[:'maxMsgCountPerRead']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          max_msg_count_per_read == o.max_msg_count_per_read &&
          metadata == o.metadata &&
          password == o.password &&
          streams == o.streams &&
          tls == o.tls &&
    ...
    def hash
      [consumer_group, db, filter, host_address, max_msg_count_per_read, metadata, password, streams, tls, username].hash
    end
