...
module argo-workflows
  class IoArgoprojEventsV1alpha1SNSEventSource
    ...
    attr_accessor :validate_signature
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'validateSignature')
        self.validate_signature = attributes[:'validateSignature']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          validate_signature == o.validate_signature &&
          webhook == o.webhook
    end
    ...
    def hash
      [access_key, endpoint, filter, metadata, region, role_arn, secret_key, topic_arn, validate_signature, webhook].hash
    end
