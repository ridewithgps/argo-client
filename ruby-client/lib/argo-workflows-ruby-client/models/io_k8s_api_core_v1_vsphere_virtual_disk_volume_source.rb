...
module argo-workflows
  ...
  class IoK8sApiCoreV1VsphereVirtualDiskVolumeSource
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'storagePolicyID')
        self.storage_policy_id = attributes[:'storagePolicyID']
      end

      if attributes.has_key?(:'storagePolicyName')
        self.storage_policy_name = attributes[:'storagePolicyName']
      end

      if attributes.has_key?(:'volumePath')
        self.volume_path = attributes[:'volumePath']
      end
    end
