...
module argo-workflows
  ...
  class IoK8sApiCoreV1ServicePort
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'appProtocol')
        self.app_protocol = attributes[:'appProtocol']
      end
      ...
      if attributes.has_key?(:'nodePort')
        self.node_port = attributes[:'nodePort']
      end
      ...
      if attributes.has_key?(:'targetPort')
        self.target_port = attributes[:'targetPort']
      end
    end
