...
module argo-workflows
  ...
  class IoArgoprojWorkflowV1alpha1CronWorkflowStatus
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'lastScheduledTime')
        self.last_scheduled_time = attributes[:'lastScheduledTime']
      end
    ...
    def hash
      [active, conditions, failed, last_scheduled_time, phase, succeeded].hash
    end
