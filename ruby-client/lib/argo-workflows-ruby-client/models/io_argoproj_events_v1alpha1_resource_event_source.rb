...
module argo-workflows
  ...
  class IoArgoprojEventsV1alpha1ResourceEventSource
    ...
    attr_accessor :group_version_resource
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'groupVersionResource')
        self.group_version_resource = attributes[:'groupVersionResource']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          filter == o.filter &&
          group_version_resource == o.group_version_resource &&
          metadata == o.metadata &&
    ...
    def hash
      [event_types, filter, group_version_resource, metadata, namespace].hash
    end
