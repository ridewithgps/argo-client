...
module argo-workflows
  class IoArgoprojEventsV1alpha1BitbucketServerEventSource
    ...
    attr_accessor :bitbucketserver_base_url
    ...
    def self.swagger_types
      {
        ...
        :'bitbucketserver_base_url' => :'String',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'bitbucketserverBaseURL')
        self.bitbucketserver_base_url = attributes[:'bitbucketserverBaseURL']
      end
      ...
      if attributes.has_key?(:'repositorySlug')
        self.repository_slug = attributes[:'repositorySlug']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          bitbucketserver_base_url == o.bitbucketserver_base_url &&
          ...
          repository_slug == o.repository_slug &&
          tls == o.tls &&
          webhook == o.webhook &&
    ...
    def hash
      [access_token, bitbucketserver_base_url, delete_hook_on_finish, events, filter, metadata, project_key, repositories, repository_slug, tls, webhook, webhook_secret].hash
    end
