...
module argo-workflows
  ...
  class IoArgoprojEventsV1alpha1PulsarTrigger
    ...
    def hash
      [auth_athenz_params, auth_athenz_secret, auth_token_secret, connection_backoff, parameters, payload, tls, tls_allow_insecure_connection, tls_trust_certs_secret, tls_validate_hostname, topic, url].hash
    end
