...
module argo-workflows
  class EventsourceLogEntry
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'eventSourceType')
        self.event_source_type = attributes[:'eventSourceType']
      end
    ...
    def hash
      [event_name, event_source_name, event_source_type, level, msg, namespace, time].hash
    end
