...
module argo-workflows
  ...
  class IoArgoprojWorkflowV1alpha1CronWorkflowSpec
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'stopStrategy')
        self.stop_strategy = attributes[:'stopStrategy']
      end
      ...
      if attributes.has_key?(:'workflowSpec')
        self.workflow_spec = attributes[:'workflowSpec']
      end
    end
    ...
    def hash
      [concurrency_policy, failed_jobs_history_limit, schedule, schedules, starting_deadline_seconds, stop_strategy, successful_jobs_history_limit, suspend, timezone, _when, workflow_metadata, workflow_spec].hash
    end
