...
module argo-workflows
  class IoArgoprojEventsV1alpha1AMQPQueueDeclareConfig
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'autoDelete')
        self.auto_delete = attributes[:'autoDelete']
      end

      if attributes.has_key?(:'durable')
    ...
    def hash
      [arguments, auto_delete, durable, exclusive, name, no_wait].hash
    end
