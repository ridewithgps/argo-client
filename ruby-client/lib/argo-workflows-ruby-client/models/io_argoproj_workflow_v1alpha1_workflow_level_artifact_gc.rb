...
module argo-workflows
  ...
  class IoArgoprojWorkflowV1alpha1WorkflowLevelArtifactGC
    ...
    attr_accessor :force_finalizer_removal
    ...
    def self.swagger_types
      {
        :'force_finalizer_removal' => :'BOOLEAN',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'forceFinalizerRemoval')
        self.force_finalizer_removal = attributes[:'forceFinalizerRemoval']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          force_finalizer_removal == o.force_finalizer_removal &&
    ...
    def hash
      [force_finalizer_removal, pod_metadata, pod_spec_patch, service_account_name, strategy].hash
    end
