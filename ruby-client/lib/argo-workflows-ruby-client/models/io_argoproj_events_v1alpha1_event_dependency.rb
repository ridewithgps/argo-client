...
module argo-workflows
  class IoArgoprojEventsV1alpha1EventDependency
    ...
    attr_accessor :filters_logical_operator
    ...
    def self.swagger_types
      {
        ...
        :'filters_logical_operator' => :'String',
        :'name' => :'String',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'eventSourceName')
        self.event_source_name = attributes[:'eventSourceName']
      end
      ...
      if attributes.has_key?(:'filtersLogicalOperator')
        self.filters_logical_operator = attributes[:'filtersLogicalOperator']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          filters == o.filters &&
          filters_logical_operator == o.filters_logical_operator &&
          name == o.name &&
    ...
    def hash
      [event_name, event_source_name, filters, filters_logical_operator, name, transform].hash
    end
