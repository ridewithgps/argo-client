...
module argo-workflows
  class IoArgoprojEventsV1alpha1AzureServiceBusEventSource
    ...
    attr_accessor :fully_qualified_namespace
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'fullyQualifiedNamespace')
        self.fully_qualified_namespace = attributes[:'fullyQualifiedNamespace']
      end
      ...
      if attributes.has_key?(:'subscriptionName')
        self.subscription_name = attributes[:'subscriptionName']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          filter == o.filter &&
          fully_qualified_namespace == o.fully_qualified_namespace &&
    ...
    def hash
      [connection_string, filter, fully_qualified_namespace, json_body, metadata, queue_name, subscription_name, tls, topic_name].hash
    end
