...
module ArgoWorkflows
  ...
  class IoK8sApiCoreV1CSIVolumeSource
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'nodePublishSecretRef')
        self.node_publish_secret_ref = attributes[:'nodePublishSecretRef']
      end
      ...
      if attributes.has_key?(:'volumeAttributes')
        if (value = attributes[:'volumeAttributes']).is_a?(Hash)
