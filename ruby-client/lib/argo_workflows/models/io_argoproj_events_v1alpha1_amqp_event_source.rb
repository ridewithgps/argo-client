...
module ArgoWorkflows
  class IoArgoprojEventsV1alpha1AMQPEventSource
    ...
    attr_accessor :exchange_declare
    ...
    attr_accessor :queue_bind

    attr_accessor :queue_declare
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'consume')
        self.consume = attributes[:'consume']
      end

      if attributes.has_key?(:'exchangeDeclare')
        self.exchange_declare = attributes[:'exchangeDeclare']
      end

      if attributes.has_key?(:'exchangeName')
        self.exchange_name = attributes[:'exchangeName']
      end

      if attributes.has_key?(:'exchangeType')
        self.exchange_type = attributes[:'exchangeType']
      end
      ...
      if attributes.has_key?(:'queueBind')
        self.queue_bind = attributes[:'queueBind']
      end

      if attributes.has_key?(:'queueDeclare')
        self.queue_declare = attributes[:'queueDeclare']
      end
      ...
      if attributes.has_key?(:'urlSecret')
        self.url_secret = attributes[:'urlSecret']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          consume == o.consume &&
          exchange_declare == o.exchange_declare &&
          exchange_name == o.exchange_name &&
          exchange_type == o.exchange_type &&
          filter == o.filter &&
          json_body == o.json_body &&
          metadata == o.metadata &&
          queue_bind == o.queue_bind &&
          queue_declare == o.queue_declare &&
          routing_key == o.routing_key &&
          tls == o.tls &&
          url == o.url &&
          url_secret == o.url_secret
    end
    ...
    def hash
      [auth, connection_backoff, consume, exchange_declare, exchange_name, exchange_type, filter, json_body, metadata, queue_bind, queue_declare, routing_key, tls, url, url_secret].hash
    end
