...
module ArgoWorkflows
  ...
  class IoArgoprojWorkflowV1alpha1AzureArtifactRepository
    ...
    attr_accessor :blob_name_format
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'blobNameFormat')
        self.blob_name_format = attributes[:'blobNameFormat']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          blob_name_format == o.blob_name_format &&
    ...
    def hash
      [account_key_secret, blob_name_format, container, endpoint, use_sdk_creds].hash
    end
