...
module ArgoWorkflows
  class IoArgoprojEventsV1alpha1EmitterEventSource
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'broker')
        self.broker = attributes[:'broker']
      end

      if attributes.has_key?(:'channelKey')
        self.channel_key = attributes[:'channelKey']
      end
    ...
    def hash
      [broker, channel_key, channel_name, connection_backoff, filter, json_body, metadata, password, tls, username].hash
    end
