...
module ArgoWorkflows
  ...
  class IoK8sApiCoreV1NodeAffinity
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'preferredDuringSchedulingIgnoredDuringExecution')
        if (value = attributes[:'preferredDuringSchedulingIgnoredDuringExecution']).is_a?(Array)
          self.preferred_during_scheduling_ignored_during_execution = value
        end
      end

      if attributes.has_key?(:'requiredDuringSchedulingIgnoredDuringExecution')
        self.required_during_scheduling_ignored_during_execution = attributes[:'requiredDuringSchedulingIgnoredDuringExecution']
      end
    end
