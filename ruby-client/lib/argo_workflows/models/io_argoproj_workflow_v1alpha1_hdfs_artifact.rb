...
module ArgoWorkflows
  ...
  class IoArgoprojWorkflowV1alpha1HDFSArtifact
    ...
    def hash
      [addresses, data_transfer_protection, force, hdfs_user, krb_c_cache_secret, krb_config_config_map, krb_keytab_secret, krb_realm, krb_service_principal_name, krb_username, path].hash
    end
