...
module ArgoWorkflows
  class IoArgoprojEventsV1alpha1SASLConfig
    ...
    def self.swagger_types
      {
        ...
        :'user_secret' => :'IoK8sApiCoreV1SecretKeySelector'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'userSecret')
        self.user_secret = attributes[:'userSecret']
      end
    end
    ...
    def hash
      [mechanism, password_secret, user_secret].hash
    end
