...
module ArgoWorkflows
  class IoArgoprojWorkflowV1alpha1Submit
    ...
    def list_invalid_properties
      ...
      if @workflow_template_ref.nil?
        invalid_properties.push('invalid value for "workflow_template_ref", workflow_template_ref cannot be nil.')
      end
    ...
    def valid?
      return false if @workflow_template_ref.nil?
      true
    end
    ...
    def hash
      [arguments, metadata, workflow_template_ref].hash
    end
