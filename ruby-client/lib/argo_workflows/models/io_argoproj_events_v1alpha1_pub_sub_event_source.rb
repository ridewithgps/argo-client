...
module ArgoWorkflows
  ...
  class IoArgoprojEventsV1alpha1PubSubEventSource
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'credentialSecret')
        self.credential_secret = attributes[:'credentialSecret']
      end

      if attributes.has_key?(:'deleteSubscriptionOnFinish')
        self.delete_subscription_on_finish = attributes[:'deleteSubscriptionOnFinish']
      end
      ...
      if attributes.has_key?(:'topicProjectID')
        self.topic_project_id = attributes[:'topicProjectID']
      end
    end
    ...
    def hash
      [credential_secret, delete_subscription_on_finish, filter, json_body, metadata, project_id, subscription_id, topic, topic_project_id].hash
    end
