...
module ArgoWorkflows
  ...
  class IoArgoprojWorkflowV1alpha1ScriptTemplate
    ...
    def hash
      [args, command, env, env_from, image, image_pull_policy, lifecycle, liveness_probe, name, ports, readiness_probe, resize_policy, resources, restart_policy, security_context, source, startup_probe, stdin, stdin_once, termination_message_path, termination_message_policy, tty, volume_devices, volume_mounts, working_dir].hash
    end
