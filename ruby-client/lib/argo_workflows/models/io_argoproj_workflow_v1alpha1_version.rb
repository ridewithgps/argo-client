...
module ArgoWorkflows
  class IoArgoprojWorkflowV1alpha1Version
    ...
    def list_invalid_properties
      ...
      if @git_tag.nil?
        invalid_properties.push('invalid value for "git_tag", git_tag cannot be nil.')
      end
    ...
    def hash
      [build_date, compiler, git_commit, git_tag, git_tree_state, go_version, platform, version].hash
    end
