...
module ArgoWorkflows
  class SensorLogEntry
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'eventContext')
        self.event_context = attributes[:'eventContext']
      end
      ...
      if attributes.has_key?(:'sensorName')
        self.sensor_name = attributes[:'sensorName']
      end
      ...
      if attributes.has_key?(:'triggerName')
        self.trigger_name = attributes[:'triggerName']
      end
    end
    ...
    def hash
      [dependency_name, event_context, level, msg, namespace, sensor_name, time, trigger_name].hash
    end
