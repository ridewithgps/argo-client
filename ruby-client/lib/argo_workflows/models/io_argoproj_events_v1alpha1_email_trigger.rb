...
module ArgoWorkflows
  ...
  class IoArgoprojEventsV1alpha1EmailTrigger
    ...
    def self.swagger_types
      {
        ...
        :'port' => :'Integer',
        :'smtp_password' => :'IoK8sApiCoreV1SecretKeySelector',
        :'subject' => :'String',
        :'to' => :'Array<String>',
        :'username' => :'String'
      }
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'smtpPassword')
        self.smtp_password = attributes[:'smtpPassword']
      end
    ...
    def hash
      [body, from, host, parameters, port, smtp_password, subject, to, username].hash
    end
