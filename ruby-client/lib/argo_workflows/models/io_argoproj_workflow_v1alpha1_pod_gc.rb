...
module ArgoWorkflows
  ...
  class IoArgoprojWorkflowV1alpha1PodGC
    ...
    attr_accessor :delete_delay_duration
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'deleteDelayDuration')
        self.delete_delay_duration = attributes[:'deleteDelayDuration']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          delete_delay_duration == o.delete_delay_duration &&
    ...
    def hash
      [delete_delay_duration, label_selector, strategy].hash
    end
