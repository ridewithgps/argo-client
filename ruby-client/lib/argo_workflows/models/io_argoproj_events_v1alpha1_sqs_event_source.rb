...
module ArgoWorkflows
  class IoArgoprojEventsV1alpha1SQSEventSource
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'queueAccountId')
        self.queue_account_id = attributes[:'queueAccountId']
      end
      ...
      if attributes.has_key?(:'waitTimeSeconds')
        self.wait_time_seconds = attributes[:'waitTimeSeconds']
      end
    end
    ...
    def hash
      [access_key, dlq, endpoint, filter, json_body, metadata, queue, queue_account_id, region, role_arn, secret_key, session_token, wait_time_seconds].hash
    end
