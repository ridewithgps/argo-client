...
module ArgoWorkflows
  class IoArgoprojEventsV1alpha1AzureEventHubsTrigger
    ...
    attr_accessor :shared_access_key_name
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'sharedAccessKey')
        self.shared_access_key = attributes[:'sharedAccessKey']
      end

      if attributes.has_key?(:'sharedAccessKeyName')
        self.shared_access_key_name = attributes[:'sharedAccessKeyName']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          payload == o.payload &&
          shared_access_key == o.shared_access_key &&
          shared_access_key_name == o.shared_access_key_name
    end
    ...
    def hash
      [fqdn, hub_name, parameters, payload, shared_access_key, shared_access_key_name].hash
    end
