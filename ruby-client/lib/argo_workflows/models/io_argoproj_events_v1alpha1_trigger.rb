...
module ArgoWorkflows
  class IoArgoprojEventsV1alpha1Trigger
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'atLeastOnce')
        self.at_least_once = attributes[:'atLeastOnce']
      end
      ...
      if attributes.has_key?(:'rateLimit')
        self.rate_limit = attributes[:'rateLimit']
      end
    ...
    def hash
      [at_least_once, parameters, policy, rate_limit, retry_strategy, template].hash
    end
