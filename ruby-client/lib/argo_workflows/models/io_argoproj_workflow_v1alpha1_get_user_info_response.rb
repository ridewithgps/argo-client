...
module ArgoWorkflows
  class IoArgoprojWorkflowV1alpha1GetUserInfoResponse
    ...
    attr_accessor :service_account_namespace
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'serviceAccountNamespace')
        self.service_account_namespace = attributes[:'serviceAccountNamespace']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          service_account_namespace == o.service_account_namespace &&
          subject == o.subject
    end
    ...
    def hash
      [email, email_verified, groups, issuer, name, service_account_name, service_account_namespace, subject].hash
    end
