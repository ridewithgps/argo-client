...
module ArgoWorkflows
  ...
  class IoArgoprojWorkflowV1alpha1GCSArtifactRepository
    ...
    attr_accessor :service_account_key_secret
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'serviceAccountKeySecret')
        self.service_account_key_secret = attributes[:'serviceAccountKeySecret']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          service_account_key_secret == o.service_account_key_secret
    end
    ...
    def hash
      [bucket, key_format, service_account_key_secret].hash
    end
