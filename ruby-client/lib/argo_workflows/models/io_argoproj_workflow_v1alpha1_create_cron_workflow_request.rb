...
module ArgoWorkflows
  class IoArgoprojWorkflowV1alpha1CreateCronWorkflowRequest
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'createOptions')
        self.create_options = attributes[:'createOptions']
      end

      if attributes.has_key?(:'cronWorkflow')
        self.cron_workflow = attributes[:'cronWorkflow']
      end
    ...
    def hash
      [create_options, cron_workflow, namespace].hash
    end
