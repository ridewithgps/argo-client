...
module ArgoWorkflows
  ...
  class IoArgoprojWorkflowV1alpha1ValueFrom
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'jqFilter')
        self.jq_filter = attributes[:'jqFilter']
      end

      if attributes.has_key?(:'jsonPath')
        self.json_path = attributes[:'jsonPath']
      end
      ...
      if attributes.has_key?(:'supplied')
        self.supplied = attributes[:'supplied']
      end
    end
    ...
    def hash
      [config_map_key_ref, default, event, expression, jq_filter, json_path, parameter, path, supplied].hash
    end
