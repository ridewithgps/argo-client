...
module ArgoWorkflows
  ...
  class IoK8sApiCoreV1Affinity
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'podAffinity')
        self.pod_affinity = attributes[:'podAffinity']
      end

      if attributes.has_key?(:'podAntiAffinity')
        self.pod_anti_affinity = attributes[:'podAntiAffinity']
      end
    end
