...
module ArgoWorkflows
  class EventSourceServiceApi
    ...
    def event_source_service_create_event_source(namespace, body, opts = {})
      data, _status_code, _headers = event_source_service_create_event_source_with_http_info(namespace, body, opts)
      data
    end
    ...
    # @param body 
    # @param [Hash] opts the optional parameters
    # @return [Array<(IoArgoprojEventsV1alpha1EventSource, Fixnum, Hash)>] IoArgoprojEventsV1alpha1EventSource data, response status code and response headers
    def event_source_service_create_event_source_with_http_info(namespace, body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: EventSourceServiceApi.event_source_service_create_event_source ...'
      end
      # verify the required parameter 'namespace' is set
      if @api_client.config.client_side_validation && namespace.nil?
        fail ArgumentError, "Missing the required parameter 'namespace' when calling EventSourceServiceApi.event_source_service_create_event_source"
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling EventSourceServiceApi.event_source_service_create_event_source"
      end
      # resource path
      local_var_path = '/api/v1/event-sources/{namespace}'.sub('{' + 'namespace' + '}', namespace.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :return_type => 'IoArgoprojEventsV1alpha1EventSource')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: EventSourceServiceApi#event_source_service_create_event_source\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def event_source_service_delete_event_source(namespace, name, opts = {})
      data, _status_code, _headers = event_source_service_delete_event_source_with_http_info(namespace, name, opts)
      data
    end
    ...
    # @option opts [String] :delete_options_propagation_policy Whether and how garbage collection will be performed. Either this field or OrphanDependents may be set, but not both. The default policy is decided by the existing finalizer set in the metadata.finalizers and the resource-specific default policy. Acceptable values are: &#39;Orphan&#39; - orphan the dependents; &#39;Background&#39; - allow the garbage collector to delete the dependents in the background; &#39;Foreground&#39; - a cascading policy that deletes all dependents in the foreground. +optional.
    # @option opts [Array<String>] :delete_options_dry_run When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed +optional +listType&#x3D;atomic.
    # @return [Array<(EventsourceEventSourceDeletedResponse, Fixnum, Hash)>] EventsourceEventSourceDeletedResponse data, response status code and response headers
    def event_source_service_delete_event_source_with_http_info(namespace, name, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: EventSourceServiceApi.event_source_service_delete_event_source ...'
      end
      # verify the required parameter 'namespace' is set
      if @api_client.config.client_side_validation && namespace.nil?
        fail ArgumentError, "Missing the required parameter 'namespace' when calling EventSourceServiceApi.event_source_service_delete_event_source"
      end
      # verify the required parameter 'name' is set
      if @api_client.config.client_side_validation && name.nil?
        fail ArgumentError, "Missing the required parameter 'name' when calling EventSourceServiceApi.event_source_service_delete_event_source"
      end
      # resource path
      local_var_path = '/api/v1/event-sources/{namespace}/{name}'.sub('{' + 'namespace' + '}', namespace.to_s).sub('{' + 'name' + '}', name.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:DELETE, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'EventsourceEventSourceDeletedResponse')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: EventSourceServiceApi#event_source_service_delete_event_source\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    # @param namespace 
    # @param [Hash] opts the optional parameters
    # @option opts [String] :name optional - only return entries for this event source.
    # @option opts [String] :event_source_type optional - only return entries for this event source type (e.g. &#x60;webhook&#x60;).
    # @option opts [String] :event_name optional - only return entries for this event name (e.g. &#x60;example&#x60;).
    # @option opts [String] :grep optional - only return entries where &#x60;msg&#x60; matches this regular expression.
    ...
    def event_source_service_event_sources_logs(namespace, opts = {})
      data, _status_code, _headers = event_source_service_event_sources_logs_with_http_info(namespace, opts)
      data
    end
    ...
    # @option opts [String] :pod_log_options_limit_bytes If set, the number of bytes to read from the server before terminating the log output. This may not display a complete final line of logging, and may return slightly more or slightly less than the specified limit. +optional.
    # @option opts [BOOLEAN] :pod_log_options_insecure_skip_tls_verify_backend insecureSkipTLSVerifyBackend indicates that the apiserver should not confirm the validity of the serving certificate of the backend it is connecting to.  This will make the HTTPS connection between the apiserver and the backend insecure. This means the apiserver cannot verify the log data it is receiving came from the real kubelet.  If the kubelet is configured to verify the apiserver&#39;s TLS credentials, it does not mean the connection to the real kubelet is vulnerable to a man in the middle attack (e.g. an attacker could not intercept the actual log data coming from the real kubelet). +optional.
    # @return [Array<(StreamResultOfEventsourceLogEntry, Fixnum, Hash)>] StreamResultOfEventsourceLogEntry data, response status code and response headers
    def event_source_service_event_sources_logs_with_http_info(namespace, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: EventSourceServiceApi.event_source_service_event_sources_logs ...'
      end
      # verify the required parameter 'namespace' is set
      if @api_client.config.client_side_validation && namespace.nil?
        fail ArgumentError, "Missing the required parameter 'namespace' when calling EventSourceServiceApi.event_source_service_event_sources_logs"
      end
      # resource path
      local_var_path = '/api/v1/stream/event-sources/{namespace}/logs'.sub('{' + 'namespace' + '}', namespace.to_s)

      # query parameters
      query_params = {}
      query_params[:'name'] = opts[:'name'] if !opts[:'name'].nil?
      query_params[:'eventSourceType'] = opts[:'event_source_type'] if !opts[:'event_source_type'].nil?
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'StreamResultOfEventsourceLogEntry')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: EventSourceServiceApi#event_source_service_event_sources_logs\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    # @param namespace 
    ...
    # @param [Hash] opts the optional parameters
    # @return [IoArgoprojEventsV1alpha1EventSource]
    def event_source_service_get_event_source(namespace, name, opts = {})
      data, _status_code, _headers = event_source_service_get_event_source_with_http_info(namespace, name, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(IoArgoprojEventsV1alpha1EventSource, Fixnum, Hash)>] IoArgoprojEventsV1alpha1EventSource data, response status code and response headers
    def event_source_service_get_event_source_with_http_info(namespace, name, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: EventSourceServiceApi.event_source_service_get_event_source ...'
      end
      # verify the required parameter 'namespace' is set
      if @api_client.config.client_side_validation && namespace.nil?
        fail ArgumentError, "Missing the required parameter 'namespace' when calling EventSourceServiceApi.event_source_service_get_event_source"
      end
      # verify the required parameter 'name' is set
      if @api_client.config.client_side_validation && name.nil?
        fail ArgumentError, "Missing the required parameter 'name' when calling EventSourceServiceApi.event_source_service_get_event_source"
      end
      # resource path
      local_var_path = '/api/v1/event-sources/{namespace}/{name}'.sub('{' + 'namespace' + '}', namespace.to_s).sub('{' + 'name' + '}', name.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'IoArgoprojEventsV1alpha1EventSource')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: EventSourceServiceApi#event_source_service_get_event_source\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    # @param namespace 
    ...
    def event_source_service_list_event_sources(namespace, opts = {})
      data, _status_code, _headers = event_source_service_list_event_sources_with_http_info(namespace, opts)
      data
    end
    ...
    # @option opts [String] :list_options_continue The continue option should be set when retrieving more results from the server. Since this value is server defined, clients may only use the continue value from a previous query result with identical query parameters (except for the value of continue) and the server may reject a continue value it does not recognize. If the specified continue value is no longer valid whether due to expiration (generally five to fifteen minutes) or a configuration change on the server, the server will respond with a 410 ResourceExpired error together with a continue token. If the client needs a consistent list, it must restart their list without the continue field. Otherwise, the client may send another list request with the token received with the 410 error, the server will respond with a list starting from the next key, but from the latest snapshot, which is inconsistent from the previous list results - objects that are created, modified, or deleted after the first list request will be included in the response, as long as their keys are after the \&quot;next key\&quot;.  This field is not supported when watch is true. Clients may start a watch from the last resourceVersion value returned by the server and not miss any modifications.
    # @option opts [BOOLEAN] :list_options_send_initial_events &#x60;sendInitialEvents&#x3D;true&#x60; may be set together with &#x60;watch&#x3D;true&#x60;. In that case, the watch stream will begin with synthetic events to produce the current state of objects in the collection. Once all such events have been sent, a synthetic \&quot;Bookmark\&quot; event  will be sent. The bookmark will report the ResourceVersion (RV) corresponding to the set of objects, and be marked with &#x60;\&quot;io.k8s.initial-events-end\&quot;: \&quot;true\&quot;&#x60; annotation. Afterwards, the watch stream will proceed as usual, sending watch events corresponding to changes (subsequent to the RV) to objects watched.  When &#x60;sendInitialEvents&#x60; option is set, we require &#x60;resourceVersionMatch&#x60; option to also be set. The semantic of the watch request is as following: - &#x60;resourceVersionMatch&#x60; &#x3D; NotOlderThan   is interpreted as \&quot;data at least as new as the provided &#x60;resourceVersion&#x60;\&quot;   and the bookmark event is send when the state is synced   to a &#x60;resourceVersion&#x60; at least as fresh as the one provided by the ListOptions.   If &#x60;resourceVersion&#x60; is unset, this is interpreted as \&quot;consistent read\&quot; and the   bookmark event is send when the state is synced at least to the moment   when request started being processed. - &#x60;resourceVersionMatch&#x60; set to any other value or unset   Invalid error is returned.  Defaults to true if &#x60;resourceVersion&#x3D;\&quot;\&quot;&#x60; or &#x60;resourceVersion&#x3D;\&quot;0\&quot;&#x60; (for backward compatibility reasons) and to false otherwise. +optional
    # @return [Array<(IoArgoprojEventsV1alpha1EventSourceList, Fixnum, Hash)>] IoArgoprojEventsV1alpha1EventSourceList data, response status code and response headers
    def event_source_service_list_event_sources_with_http_info(namespace, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: EventSourceServiceApi.event_source_service_list_event_sources ...'
      end
      # verify the required parameter 'namespace' is set
      if @api_client.config.client_side_validation && namespace.nil?
        fail ArgumentError, "Missing the required parameter 'namespace' when calling EventSourceServiceApi.event_source_service_list_event_sources"
      end
      # resource path
      local_var_path = '/api/v1/event-sources/{namespace}'.sub('{' + 'namespace' + '}', namespace.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'IoArgoprojEventsV1alpha1EventSourceList')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: EventSourceServiceApi#event_source_service_list_event_sources\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    # @param namespace 
    ...
    # @param [Hash] opts the optional parameters
    # @return [IoArgoprojEventsV1alpha1EventSource]
    def event_source_service_update_event_source(namespace, name, body, opts = {})
      data, _status_code, _headers = event_source_service_update_event_source_with_http_info(namespace, name, body, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(IoArgoprojEventsV1alpha1EventSource, Fixnum, Hash)>] IoArgoprojEventsV1alpha1EventSource data, response status code and response headers
    def event_source_service_update_event_source_with_http_info(namespace, name, body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: EventSourceServiceApi.event_source_service_update_event_source ...'
      end
      # verify the required parameter 'namespace' is set
      if @api_client.config.client_side_validation && namespace.nil?
        fail ArgumentError, "Missing the required parameter 'namespace' when calling EventSourceServiceApi.event_source_service_update_event_source"
      end
      # verify the required parameter 'name' is set
      if @api_client.config.client_side_validation && name.nil?
        fail ArgumentError, "Missing the required parameter 'name' when calling EventSourceServiceApi.event_source_service_update_event_source"
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling EventSourceServiceApi.event_source_service_update_event_source"
      end
      # resource path
      local_var_path = '/api/v1/event-sources/{namespace}/{name}'.sub('{' + 'namespace' + '}', namespace.to_s).sub('{' + 'name' + '}', name.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path,
        ...
        :return_type => 'IoArgoprojEventsV1alpha1EventSource')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: EventSourceServiceApi#event_source_service_update_event_source\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    # @param namespace 
    ...
    def event_source_service_watch_event_sources(namespace, opts = {})
      data, _status_code, _headers = event_source_service_watch_event_sources_with_http_info(namespace, opts)
      data
    end
    ...
    # @option opts [String] :list_options_continue The continue option should be set when retrieving more results from the server. Since this value is server defined, clients may only use the continue value from a previous query result with identical query parameters (except for the value of continue) and the server may reject a continue value it does not recognize. If the specified continue value is no longer valid whether due to expiration (generally five to fifteen minutes) or a configuration change on the server, the server will respond with a 410 ResourceExpired error together with a continue token. If the client needs a consistent list, it must restart their list without the continue field. Otherwise, the client may send another list request with the token received with the 410 error, the server will respond with a list starting from the next key, but from the latest snapshot, which is inconsistent from the previous list results - objects that are created, modified, or deleted after the first list request will be included in the response, as long as their keys are after the \&quot;next key\&quot;.  This field is not supported when watch is true. Clients may start a watch from the last resourceVersion value returned by the server and not miss any modifications.
    # @option opts [BOOLEAN] :list_options_send_initial_events &#x60;sendInitialEvents&#x3D;true&#x60; may be set together with &#x60;watch&#x3D;true&#x60;. In that case, the watch stream will begin with synthetic events to produce the current state of objects in the collection. Once all such events have been sent, a synthetic \&quot;Bookmark\&quot; event  will be sent. The bookmark will report the ResourceVersion (RV) corresponding to the set of objects, and be marked with &#x60;\&quot;io.k8s.initial-events-end\&quot;: \&quot;true\&quot;&#x60; annotation. Afterwards, the watch stream will proceed as usual, sending watch events corresponding to changes (subsequent to the RV) to objects watched.  When &#x60;sendInitialEvents&#x60; option is set, we require &#x60;resourceVersionMatch&#x60; option to also be set. The semantic of the watch request is as following: - &#x60;resourceVersionMatch&#x60; &#x3D; NotOlderThan   is interpreted as \&quot;data at least as new as the provided &#x60;resourceVersion&#x60;\&quot;   and the bookmark event is send when the state is synced   to a &#x60;resourceVersion&#x60; at least as fresh as the one provided by the ListOptions.   If &#x60;resourceVersion&#x60; is unset, this is interpreted as \&quot;consistent read\&quot; and the   bookmark event is send when the state is synced at least to the moment   when request started being processed. - &#x60;resourceVersionMatch&#x60; set to any other value or unset   Invalid error is returned.  Defaults to true if &#x60;resourceVersion&#x3D;\&quot;\&quot;&#x60; or &#x60;resourceVersion&#x3D;\&quot;0\&quot;&#x60; (for backward compatibility reasons) and to false otherwise. +optional
    # @return [Array<(StreamResultOfEventsourceEventSourceWatchEvent, Fixnum, Hash)>] StreamResultOfEventsourceEventSourceWatchEvent data, response status code and response headers
    def event_source_service_watch_event_sources_with_http_info(namespace, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: EventSourceServiceApi.event_source_service_watch_event_sources ...'
      end
      # verify the required parameter 'namespace' is set
      if @api_client.config.client_side_validation && namespace.nil?
        fail ArgumentError, "Missing the required parameter 'namespace' when calling EventSourceServiceApi.event_source_service_watch_event_sources"
      end
      # resource path
      local_var_path = '/api/v1/stream/event-sources/{namespace}'.sub('{' + 'namespace' + '}', namespace.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'StreamResultOfEventsourceEventSourceWatchEvent')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: EventSourceServiceApi#event_source_service_watch_event_sources\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
